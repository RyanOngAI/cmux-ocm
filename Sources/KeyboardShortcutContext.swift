...
extension KeyboardShortcutSettings.Action {
    ...
    var shortcutContext: ShortcutContext {
        ...
        case .diffViewerScrollDown,
            ...
            return .browserPanel
        case .switchRightSidebarToFiles, .switchRightSidebarToFind, .switchRightSidebarToChanges, .switchRightSidebarToSessions, .switchRightSidebarToFeed, .switchRightSidebarToDock:
