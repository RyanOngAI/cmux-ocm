...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.app, "file-editor-syntax-highlighting", String(localized: "settings.app.fileEditorSyntaxHighlighting", defaultValue: "File Editor Syntax Highlighting"), "fileEditor.syntaxHighlighting file editor syntax highlighting code colors tree-sitter python typescript tsx javascript json bash preview"),
