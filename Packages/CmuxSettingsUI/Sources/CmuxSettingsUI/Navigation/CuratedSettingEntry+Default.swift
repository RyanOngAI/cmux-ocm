...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .app, id: "file-editor-syntax-highlighting", title: "File Editor Syntax Highlighting", synonyms: "fileEditor.syntaxHighlighting file editor syntax highlighting code colors tree-sitter python typescript tsx javascript json bash preview"),
